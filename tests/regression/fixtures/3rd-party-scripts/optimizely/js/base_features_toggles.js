          ...
          layers: [
            ...
            },
            {
              ...
              experiments: [
                {
                  weightDistributions: [
                    { entityId: "17892002741", endOfRange: 10000 },
                  ],
                  audienceName: "Everyone else",
                  name: "[Haricots] Add info about blocked resubscriptions",
                  bucketingStrategy: null,
                  variations: [
                    {
                      id: "17925340804",
                          ...
                          changes: [
                            {
                              dependencies: [],
                              type: "custom_code",
                              id: "14A7A85E-4650-4D28-A9F4-3903C7DD22D1",
                              value: function ($) {
                                window.__optimizely_experiments_ran__ = {
                                  blockedResubscription: true,
                                };
                              },
                            },
                          ],
                          ...
                          changes: [
                            {
                              dependencies: [],
                              type: "custom_code",
                              id: "EDCC8E7A-3791-4963-BF44-5E38EC003BC4",
                              value: function ($) {
                                document.addEventListener(
                                  "DOMContentLoaded",
                                  function () {
            ...
            },
            {
              ...
              experiments: [
                {
                  weightDistributions: [
                    { entityId: "18142280149", endOfRange: 10000 },
                  ],
                  audienceName: "Everyone else",
                  name: "[Haricots] Limited Capacity Notice on MyGousto ",
                  bucketingStrategy: null,
                  variations: [
                    { id: "18123960153", actions: [], name: "Original" },
                    {
                      id: "18142280149",
                      actions: [
                        {
                          ...
                          changes: [
                            {
                              dependencies: [],
                              type: "custom_code",
                              id: "2F38B140-63B9-4431-9625-E04AF045DD2F",
                              value: function ($) {
                                document.addEventListener(
                                  "DOMContentLoaded",
                                  function () {
                                    if (window.__loadFeatures__) {
                                      window.__loadFeatures__({
                                        features: {
                                          ...
                                          isCommunicationPanelEnabled: true,
                                        },
                                      });
                                    } else {
                                      console.log(
      ...
      (t.maybePersistVisitorId = function (e) {
        e.randomId &&
          (z.getAutoRefresh() || t.getCurrentId() !== e.randomId
            ...
            : U.log(
                "Not persisting visitorId: value is not changed and also auto-authRefresh is disabled"
              ));
      }),
