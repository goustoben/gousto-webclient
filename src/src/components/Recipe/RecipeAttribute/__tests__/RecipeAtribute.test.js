...
describe('Recipe Attribute', () => {
  ...
  test('should return a <div>', () => {
    const wrapper = shallow( <RecipeAttribute attributeName='cookingTime' attributeValue={1} /> )
  ...
  test('should return null when showAttribute is false', () => {
    const wrapper = shallow( <RecipeAttribute attributeName='cookingTime' attributeValue={1} showAttribute={false} /> )
  ...
  test('should display the use within date formatted correctly with spaces', () => {
    const wrapper = shallow(<RecipeAttribute attributeName='useWithin' attributeValue={'5-6'} />)
    expect(wrapper.find('span').text()).toContain('Use within 5 - 6 days')
  })

  test('should display the calorie count correctly', () => {
    const wrapper = shallow(<RecipeAttribute attributeName='cals' attributeValue={123} />)
    expect(wrapper.find('span').text()).toContain('123 cals / serving')
  })

  test('should round the calorie count correctly', () => {
    const wrapper = shallow(<RecipeAttribute attributeName='cals' attributeValue={123.123} />)
    expect(wrapper.find('span').text()).toContain('123 cals / serving')
  })

  test('should display the cuisine correctly', () => {
    const wrapper = shallow(<RecipeAttribute attributeName='cuisine' attributeValue={'Italian'} />)
  ...
  test('should display the normal diet types correctly', () => {
    ...
    diets.forEach(diet => {
      const wrapper = shallow(<RecipeAttribute attributeName='diet' attributeValue={diet} />)
      expect(wrapper.find('span').text()).toContain(diet)
    })
  })

  test('should display the vegan diet type as plant-based', () => {
    const wrapper = shallow(<RecipeAttribute attributeName='diet' attributeValue={'vegan'} />)
  ...
  test('should display equipment required label without the equipment listed ', () => {
    const wrapper = shallow(<RecipeAttribute attributeName='equipmentRequired' attributeValue={Immutable.fromJS(['Spoon', 'Egg Beater'])} />)
  ...
  test('should display the equipment in a comma separated list when view="list" ', () => {
    const wrapper = shallow(<RecipeAttribute attributeName='equipmentRequired' attributeValue={Immutable.fromJS(['Spoon', 'Egg Beater'])} view={'list'} />)
