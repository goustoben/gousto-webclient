...
describe('transformers/recipes tests', () => {
  ...
  describe('menuRecipeMapper', () => {
    it('should map recipes from menuservice', () => {
      const result = menuRecipeMapper(menuserviceRecipeResponse.data)
      expect(result).toEqual(menuRecipeMapperResult)
    })
  })
})
