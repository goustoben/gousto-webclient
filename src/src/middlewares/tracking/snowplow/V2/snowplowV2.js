...
const Tracking = (action, state = {}, prevState = {}) => {
  if (globals.client) {
    ...
    trackingMap({
      ...
      [actions.RECIPE_FILTERS_OPENED_TRACKING]: trackEventWithData(recipesTracking.recipeFiltersOpened),
      [actions.RECIPE_FILTERS_CLOSED_TRACKING]: trackEventWithData(recipesTracking.recipeFiltersClosed),
      [actions.RECIPE_FILTERS_APPLIED_TRACKING]: trackEventWithData(recipesTracking.recipeFiltersApplied),
      [actions.RECIPE_FILTERS_CLEARED_TRACKING]: trackEventWithData(recipesTracking.recipeFiltersCleared),
      [actions.RECIPE_COLLECTION_SELECTED_TRACKING]: trackEventWithData(recipesTracking.recipeCollectionSelected),
      [actions.RECIPE_FILTERS_DIET_TYPE_SELECTED_TRACKING]: trackEventWithData(recipesTracking.recipeTypeSelected),
      [actions.RECIPE_FILTERS_DIET_TYPE_UNSELECTED_TRACKING]: trackEventWithData(recipesTracking.recipeTypeUnselected),
      [actions.RECIPE_FILTERS_DIETARY_ATTRIBUTE_SELECTED_TRACKING]: trackEventWithData(recipesTracking.recipeDietaryAttributeSelected),
      [actions.RECIPE_FILTERS_DIETARY_ATTRIBUTE_UNSELECTED_TRACKING]: trackEventWithData(recipesTracking.recipeDietaryAttributeUnselected),
      [actions.RECIPE_FILTERS_TOTAL_TIME_SELECTED_TRACKING]: trackEventWithData(recipesTracking.recipeTotalTimeSelected),
      [actions.RECIPE_FILTERS_TOTAL_TIME_UNSELECTED_TRACKING]: trackEventWithData(recipesTracking.recipeTotalTimeUnselected),
