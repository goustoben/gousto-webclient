...
describe('user actions', () => {
  ...
  describe('userSubscribe action', () => {
    ...
    describe('when isCheckoutRedesignEnabled feature flag is true', () => {
      const isCheckoutRedesignEnabled = true
      const sessionId = 'session-id'
      const expected = expect.objectContaining({
        customer: expect.objectContaining({ salutation_id: null })
      })
      ...
      describe('And sca3ds is true', () => {
        const sca3ds = true

        test('Then customerSignup should be called with salutation_id: null', async () => {
          await userSubscribe(sca3ds, sessionId, isCheckoutRedesignEnabled)(dispatch, getState)

          expect(customerSignup).toHaveBeenCalledWith(null, expected)
        })
      })

      describe('And sca3ds is false', () => {
        const sca3ds = false
    ...
    describe('when isCheckoutRedesignEnabled feature flag is false', () => {
      const isCheckoutRedesignEnabled = false
      const sessionId = 'session-id'
      const expected = expect.objectContaining({
        customer: expect.objectContaining({ salutation_id: undefined })
      })
      ...
      describe('And sca3ds is true', () => {
        ...
        test('then customerSignup should be called with salutation_id: undefined', async () => {
          await userSubscribe(sca3ds, sessionId, isCheckoutRedesignEnabled)(dispatch, getState)
