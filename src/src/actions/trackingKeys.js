...
export const ssrClickDoneRefundAccepted = 'ssr_ingredients_done_click'
export const ssrIngredientsAutoAcceptCheck = 'ssr_ingredients_auto_accept_check'
export const ssrIngredientsClickGetInTouch = 'ssr_ingredients_click_get_in_touch'
export const ssrIngredientsClickGoToMyGousto = 'ssr_ingredients_click_go_to_my_gousto'
...
export const ssrIngredientsOpenRefundArticle = 'ssr_ingredients_open_refund_article'
...
export const checkoutUrgencyInitialModalPrimaryButtonClicked = 'click_continue_to_checkout_urgency_modal'
...
export const checkoutUrgencyExpiredModalPrimaryButtonClicked = 'click_back_to_menu_checkout_urgency_modal'
export const sideModalSidesContinueClicked = 'sides_continue_clicked'
export const sideModalViewOrderSidesScreen = 'view_order_sides_screen'
export const sideModalOrderSidesCancel = 'order_sides_cancel'
export const sideModalAddSide = 'add_side'
export const sideModalClose = 'close'
export const sideModalViewOrderSidesAllergensScreen = 'view_order_sides_allergens_screen'
...
export const viewCreditClick = 'view_credit_click'
export const clickCorporateEnquiriesLinkFooter = 'click_corporate_enquiry_footer'
