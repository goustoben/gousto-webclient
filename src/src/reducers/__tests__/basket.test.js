...
describe('basket reducer', function () {
  ...
  describe('SHORTLIST_RECIPES_CLEAR actionType', () => {
    test('should set state shortlistLimitReached to the value from the action', () => {
      const action = {
  ...
  describe('SHORTLIST_RECIPES_POSITIONS_CLEAR actionType', () => {
    test('should set state shortlistLimitReached to the value from the action', () => {
      const action = {
      ...
      expect(Immutable.is(result, Immutable.Map({ shortlist: Immutable.Map({ shortlistRecipesPositions: Immutable.List([]) }) }))).toEqual(true)
    })
  })
})
