...
import { storeGetHelpOrder, storeSelectedAddress } from 'routes/GetHelp/actions/getHelp'
...
describe('getHelp reducer', () => {
  ...
  describe('given the action generated by storeSelectedAddress is received', () => {
    const ADDRESS = { id: '1122', name: 'Home' }

    beforeEach(() => {
      newState = getHelp(getHelpInitialState, storeSelectedAddress(ADDRESS))
    })
  ...
  describe('given an action with type GET_HELP_LOAD_SHIPPING_ADDRESSES is received', () => {
    ...
    test('the new state has the relevant addresses fields', () => {
      ...
      expect(newState.get('selectedAddress').toJS()).toEqual(ADDRESSES[0])
    })
  })
