...
describe('EditDate', () => {
  ...
  describe('rendering', () => {
    it('should render 2 dropdown inputs', () => {
    ...
    it('should render the submit button enabled when the selected slot has changed', () => {
  ...
  describe('submit button', () => {
    it('should call onSubmitFunction when clicking the submit button', () => {
