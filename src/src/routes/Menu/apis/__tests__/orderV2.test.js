...
describe('orderApi', () => {
  ...
  beforeEach(() => {
    ...
    jest.spyOn(menuFetch, 'get').mockResolvedValue(mockFetchResponse({}))
  })
  ...
  describe('getOrder', () => {
    ...
    test('should fetch the correct url', async () => {
      ...
      expect(menuFetch.get).toHaveBeenCalledTimes(1)
      expect(menuFetch.get).toHaveBeenCalledWith(
        expectedAuthOptions,
    ...
    test('should return the results of the fetch unchanged', async () => {
      const apiResponse = { data: [1, 2, 3] }
      menuFetch.get.mockResolvedValue(apiResponse)
  ...
  describe('getUserOrders', () => {
    ...
    test('should return the results of the fetch unchanged', async () => {
      const apiResponse = { data: [1, 2, 3] }
      menuFetch.get.mockResolvedValue(mockFetchResponse(apiResponse))
