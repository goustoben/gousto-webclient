...
const formatISODateToOrderV1Date = (str) => moment(str).format('YYYY-MM-DD HH:mm:ss')

// Sunday 7th March
const formatISODateToHumanReadable = (str) => moment(str).format('dddd Do MMMM')
...
const getRecipeItems = (
  ...
  return {
    ...
    recipeGoustoReference: String(safeTraversal(recipeIncludedBlock, ['attributes', 'gousto_reference'])),
    recipeId: coreId,
    recipeUuid: uuid,
...
export const transformOrderV2ToOrderV1 = (
  ...
  return {
    ...
    shippingAddress: {
      ...
      deliveryInstructions: safeTraversal(shippingAddress, ['attributes', 'delivery_instructions'], ''),
