...
describe('<RecommendedBadge />', () => {
  ...
  it('should render a badge if recipe is recommended and recommended feature set', () => {
    features = Immutable.fromJS({
      recommendedBadge: {
        value: true,
      },
  ...
  it('should not render a badge if recipe is not recommended and recommended feature set', () => {
    features = Immutable.fromJS({
  ...
  it('should not render a badge if recipe is recommended and recommended feature not set', () => {
    features = Immutable.fromJS({
