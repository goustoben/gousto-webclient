...
const ModernSlaveryStatement = () => (
  <LayoutPageWrapper>
    ...
    <section className={css.mainSection}>
      <Heading type="h1" size="xLarge" center alternateFont>Modern Slavery Statement</Heading>
      ...
      <Heading type="h2" alternateFont>Who are Gousto</Heading>
      ...
      <Heading type="h2" alternateFont>Gousto Supply Chains</Heading>
      ...
      <Heading type="h2" alternateFont>Progress to date</Heading>
      ...
      <Heading type="h2" alternateFont>Focus for next 12 months</Heading>
      <ol className={css.orderedList}>
