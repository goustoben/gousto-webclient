...
describe('Hero2', () => {
  ...
  beforeEach(() => {
    wrapper = shallow(<Hero2 />)
  })

  describe('when Hero2 component renders', () => {
    ...
    describe('onScroll', () => {
      ...
      describe('when window scroll is equal to offsetTop', () => {
        ...
        test('then should return isSticky = false', () => {
          expect(wrapper.find(Hero2).state('isSticky')).toBeFalsy()
        })
      })
      ...
      describe('when window scroll is greater than offsetTop', () => {
        ...
        test('then should return isSticky = true', () => {
          expect(wrapper.find(Hero2).state('isSticky')).toBeTruthy()
        })
      })
    })
  })
