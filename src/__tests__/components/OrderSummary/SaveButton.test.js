...
describe('SaveButton', () => {
  ...
  test('should set showError state if props saving flips off with error', () => {
  ...
  test('should set showSuccess state if props saving flips off without error', () => {
  ...
  test('should set showButton state if props saving flips off without error', () => {
  ...
  test('should show success div if showSucess state', () => {
    const wrapper = shallow(<SaveButton />)
