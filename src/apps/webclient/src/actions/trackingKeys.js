...
export const completeWizardNumberOfPeople = 'complete_wizard_number_of_people'
export const completeWizardBoxSizeRecommender = 'complete_wizard_box_size_recommender'
...
export const pairingsLoaded = 'pairings_loaded'
export const marketBundleAdded = 'market_bundle_added'
export const marketBundleBrowseItems = 'market_bundle_browse_items'
export const marketBundleDetails = 'market_bundle_detail_view'
export const marketBundleClose = 'market_bundle_close'
export const recipeCollectionSelected = 'RECIPE_COLLECTION_SELECTED'
export const viewFrequencyIncPromoModal = 'view_subscriber_incetivisation_modal'
