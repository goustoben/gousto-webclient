...
describe('Subscription action', () => {
  ...
  describe('subscriptionPauseLoadStaticScreen', () => {
    test('should return SUBSCRIPTION_PAUSE_REASON_LOAD_STATIC_SCREEN action type', () => {
  ...
  describe('subscriptionPauseLoadReasons', () => {
    const reasons = Immutable.fromJS([{ id: 'a' }, { id: 'b' }, { id: 'c' }])

    test('should return SUBSCRIPTION_PAUSE_REASON_LOAD_REASONS action type', () => {
  ...
  describe('subscriptionPauseLoadStep', () => {
    test('should return SUBSCRIPTION_PAUSE_REASON_LOAD_STEP action type', () => {
  ...
  describe('subscriptionPauseVisibilityChange', () => {
    test('should return SUBSCRIPTION_PAUSE_VISIBILITY_CHANGE action type', () => {
  ...
  describe('subscriptionPauseTrackRecover', () => {
    test('should return the expected tracking action', () => {
      expect(subPauseActions.subscriptionPauseTrackRecover()).toEqual({
        type: 'TRACKING',
        trackingData: {
  ...
  describe('subscriptionPauseApplyPromo', () => {
    ...
    test('should call statusActions pending with true for "SUBSCRIPTION_PAUSE_PROMO_APPLY" as first call to pending', async () => {
      await subPauseActions.subscriptionPauseApplyPromo()(dispatch, getState)

      expect(statusActions.pending).toHaveBeenCalledWith(
        actionTypes.SUBSCRIPTION_PAUSE_PROMO_APPLY,
        true,
      )
    })

    test('should call statusActions error with false for "SUBSCRIPTION_PAUSE_PROMO_APPLY" as first call to error', async () => {
      await subPauseActions.subscriptionPauseApplyPromo()(dispatch, getState)
    ...
    test('should call userPromoApplyCode once with provided promo code if promo code is passed in', async () => {
    ...
    test('should call userPromoApplyCode once with promo code from state if promo code is NOT passed in', async () => {
      await subPauseActions.subscriptionPauseApplyPromo()(dispatch, getState)
    ...
    test('should call statusActions pending with false for "SUBSCRIPTION_PAUSE_PROMO_APPLY" as last call', async () => {
      await subPauseActions.subscriptionPauseApplyPromo()(dispatch, getState)
    ...
    describe('when subscriptionPause data is corrupt', () => {
      ...
      test('should call subscriptionPauseLoadError with data-unavailable GoustoException as first arg', () => {
      ...
      test('should call subscriptionPauseLoadError with "SUBSCRIPTION_PAUSE_PROMO_APPLY" as second arg', () => {
        expect(subscriptionPauseLoadErrorSpy.mock.calls[0][1]).toEqual(
          actionTypes.SUBSCRIPTION_PAUSE_PROMO_APPLY,
        )
      })
    })
    ...
    describe('when promo code can not be determined', () => {
      ...
      test('should call subscriptionPauseLoadError with no-promo-code-found GoustoException as first arg', () => {
        const error = subscriptionPauseLoadErrorSpy.mock.calls[0][0]
        expect(error.message).toEqual(
          'Subscription pause promo error: promo code cannot be determined',
        )
    ...
    test('should call subscriptionPauseProceed once with "next" and "recovered"', async () => {
      getState = jest.fn().mockReturnValue({
        auth: Immutable.fromJS({ accessToken: 'token' }),
        user: Immutable.fromJS({ id: '123' }),
        subscriptionPause: Immutable.fromJS({
      ...
      expect(subscriptionPauseProceedSpy).toHaveBeenCalledWith(
        'next',
        'recovered',
        'promo',
        'abc123',
  ...
  describe('subscriptionDeactivate', () => {
    ...
    describe('when deactivation fails', () => {
      ...
      test('should call error status with deactivate-fail', () => {
        expect(statusActions.error).toHaveBeenCalledWith(
          actionTypes.SUBSCRIPTION_DEACTIVATE,
          'deactivate-fail',
        )
      })
    })
  ...
  describe('subscriptionPauseEnd', () => {
    let dispatch
    let getState
    const subscriptionPauseVisibilityChangeSpy = jest.spyOn(
      subPauseActions,
      'subscriptionPauseVisibilityChange',
    )
    const subscriptionPauseReasonsRefreshRequiredSpy = jest.spyOn(
      subPauseActions,
    ...
    test('should call subscriptionPauseVisibilityChange once with false', async () => {
    ...
    test('should call subscriptionPauseReasonsRefreshRequired once with true', async () => {
      await subPauseActions.subscriptionPauseEnd()(dispatch, getState)
  ...
  describe('subscriptionPauseStart', () => {
    ...
    const subscriptionPauseLoadReasonsSpy = jest.spyOn(
      subPauseActions,
    ...
    test('should call statusActions pending with true for "SUBSCRIPTION_PAUSE_START" as first call', async () => {
    ...
    test('should call statusActions pending with false for "SUBSCRIPTION_PAUSE_START" as last call', async () => {
      await subPauseActions.subscriptionPauseStart()(dispatch, getState)

      expect(statusActions.pending).toHaveBeenCalledWith(
        actionTypes.SUBSCRIPTION_PAUSE_START,
        false,
      )
    })
    ...
    describe('when subscriptionPause refreshRequired is true', () => {
      const subscriptionPauseFetchReasonsSpy = jest.spyOn(
        subPauseActions,
      ...
      test('should call subscriptionPauseFetchReasons once with no args', async () => {
        await subPauseActions.subscriptionPauseStart()(dispatch, getState)
      ...
      test('should call subscriptionPauseReasonsRefreshRequired once with false if there is no fetch error', async () => {
        await subPauseActions.subscriptionPauseStart()(dispatch, getState)
      ...
      test('should NOT call subscriptionPauseReasonsRefreshRequired if there is a fetch error', async () => {
        getState = jest.fn().mockReturnValue({
          features: Immutable.fromJS({}),
          auth: Immutable.fromJS({ accessToken: 'token' }),
          user: Immutable.fromJS({ id: '123' }),
      ...
      test('should call subscriptionPauseLoadStartScreen if startScreen is loaded', async () => {
        const subscriptionPauseLoadStartScreenSpy = jest.spyOn(
          subPauseActions,
    ...
    describe('when subscriptionPause refreshRequired is false', () => {
      ...
      test('should NOT call subscriptionPauseReasonsRefreshRequired', async () => {
        await subPauseActions.subscriptionPauseStart()(dispatch, getState)
    ...
    test('should call subscriptionPauseLoadReasons once with reasons from store if set', async () => {
      await subPauseActions.subscriptionPauseStart()(dispatch, getState)
    ...
    test('should call subscriptionPauseVisibilityChange once with visible set to true', async () => {
      await subPauseActions.subscriptionPauseStart()(dispatch, getState)
  ...
  describe('subscriptionPauseReasonChoice', () => {
    ...
    const subscriptionPauseReasonSubmitSpy = jest.spyOn(
      subPauseActions,
      'subscriptionPauseReasonSubmit',
    )
    const subscriptionPauseProceedSpy = jest.spyOn(subPauseActions, 'subscriptionPauseProceed')
    const subscriptionPauseLoadReasonChoiceSpy = jest.spyOn(
      subPauseActions,
    ...
    test('should call statusActions pending with true for "SUBSCRIPTION_PAUSE_REASON_CHOICE" as first call', async () => {
    ...
    test('should call statusActions error with false for "SUBSCRIPTION_PAUSE_REASON_CHOICE"', async () => {
      await subPauseActions.subscriptionPauseReasonChoice()(dispatch, getState)
    ...
    test('should call statusActions pending with true for "SUBSCRIPTION_PAUSE_REASON_CHOICE" as last call', async () => {
      await subPauseActions.subscriptionPauseReasonChoice()(dispatch, getState)
    ...
    describe('when chosen reason has children', () => {
      ...
      test("should call subscriptionPauseLoadReasons with chosen reason's children as value of arg 1", () => {
        const expectedChildren = Immutable.fromJS([{ id: 'r3' }])
        expect(
          Immutable.is(subscriptionPauseLoadReasonsSpy.mock.calls[0][0], expectedChildren),
        ).toEqual(true)
      })
    })
    ...
    describe('when chosen reason has no children', () => {
      ...
      describe('when chosen reason has NO "initial" flag set to true in any step', () => {
        ...
        test('should call subscriptionPauseLoadReasonChoice with chosen reason ids with chosenReasonId appended & correct tracking data', async () => {
          expect(
            Immutable.is(
              subscriptionPauseLoadReasonChoiceSpy.mock.calls[0][0],
              Immutable.List(['r7']),
            ),
          )
          ...
          expect(
            Immutable.is(
              subscriptionPauseLoadReasonChoiceSpy.mock.calls[1][0],
              Immutable.List(['r7', 'r9']),
            ),
          )
      ...
      describe('when chosen reason has "initial" flag set to true in any step', () => {
        ...
        test('should call subscriptionPauseTrack once with "IN_RECOVERY_EXPERIMENT" & correct experiment data if recovery feature is found in state & is an experiment', async () => {
          ...
          expect(subscriptionPauseTrackSpy).toHaveBeenCalledWith('IN_RECOVERY_EXPERIMENT', {
            experiment: 'experiment value',
          })
        })

        test('should NOT call subscriptionPauseTrack if recovery feature is not found in state or is not an experiment', async () => {
          getState = jest.fn().mockReturnValue({
            auth: Immutable.fromJS({ accessToken: 'token' }),
            user: Immutable.fromJS({
              id: '123',
          ...
          await subPauseActions.subscriptionPauseReasonChoice('r8')(
            dispatch,
            getStateNoRecoveryFeature,
          )
          expect(subscriptionPauseTrackSpy).toHaveBeenCalledTimes(0)
        })

        test('should call subscriptionPauseProceed once with "initial"', async () => {
          await subPauseActions.subscriptionPauseReasonChoice('r8')(dispatch, getState)
    ...
    describe('when reason id not provided', () => {
      ...
      test('should call subscriptionPauseLoadError with no-reason-found GoustoException as first arg', () => {
        const error = subscriptionPauseLoadErrorSpy.mock.calls[0][0]
      ...
      test('should call subscriptionPauseLoadError with "SUBSCRIPTION_PAUSE_REASON_CHOICE" as second arg', async () => {
        expect(subscriptionPauseLoadErrorSpy.mock.calls[0][1]).toEqual(
          actionTypes.SUBSCRIPTION_PAUSE_REASON_CHOICE,
        )
      })
  ...
  describe('subscriptionPauseSkipNextBox', () => {
    ...
    test('should call statusActions pending with true for "SUBSCRIPTION_PAUSE_SKIP_BOX" as first call', async () => {
      await subPauseActions.subscriptionPauseSkipNextBox()(dispatch, getState)

      expect(statusActions.pending).toHaveBeenCalledWith(
        actionTypes.SUBSCRIPTION_PAUSE_SKIP_BOX,
        true,
      )
    })

    test('should call statusActions error with false for "SUBSCRIPTION_PAUSE_SKIP_BOX"', async () => {
      await subPauseActions.subscriptionPauseSkipNextBox()(dispatch, getState)
    ...
    test('should call statusActions pending with true for "SUBSCRIPTION_PAUSE_SKIP_BOX" as last call', async () => {
      await subPauseActions.subscriptionPauseSkipNextBox()(dispatch, getState)
    ...
    test('should call subscriptionPauseProceed once with "next" and "recovered" when next box is succesfully canceled', async () => {
      getState = jest.fn().mockReturnValue({
        error: Immutable.fromJS({
    ...
    describe('when an error occurs in canceling next box due to something other than no orders found to cancel', () => {
      ...
      test('should call subscriptionPauseLoadError with failed-cancel GoustoException as first arg', () => {
        const error = subscriptionPauseLoadErrorSpy.mock.calls[0][0]
        expect(error.message).toEqual(
          'Subscription pause skip next box error: failed to cancel next box, something else',
        )
        expect(error.error).toEqual('failed-cancel')
        expect(error.level).toEqual('error')
      })

      test('should call subscriptionPauseLoadError with "SUBSCRIPTION_PAUSE_SKIP_BOX" as second arg', async () => {
        expect(subscriptionPauseLoadErrorSpy.mock.calls[0][1]).toEqual(
          actionTypes.SUBSCRIPTION_PAUSE_SKIP_BOX,
        )
      })
    ...
    test('should call userOrderSkipNextProjected once with no args when an error occurs in canceling next box due to no orders found to cancel', async () => {
      getState = jest.fn().mockReturnValue({
        error: Immutable.fromJS({
    ...
    test('should call subscriptionPauseProceed once with "next" and "recovered" when next box is succesfully skipped', async () => {
      getState = jest.fn().mockReturnValue({
        error: Immutable.fromJS({
          [actionTypes.USER_ORDER_CANCEL_NEXT]: 'no-orders-found',
    ...
    describe('when an error occurs in skipping next projected box due to something other than no orders found to skip', () => {
      ...
      test('should call subscriptionPauseLoadError with failed-skip GoustoException as first arg', () => {
        const error = subscriptionPauseLoadErrorSpy.mock.calls[0][0]
        expect(error.message).toEqual(
          'Subscription pause skip next box error: failed to skip next box, something else',
        )
    ...
    describe('when an error occurs in skipping next projected box due to no orders found to skip', () => {
      ...
      test('should call subscriptionPauseLoadError with no-orders-found GoustoException as first arg', () => {
        const error = subscriptionPauseLoadErrorSpy.mock.calls[0][0]
        expect(error.message).toEqual(
          'Subscription pause skip next box error: no orders found to cancel or skip',
        )
  ...
  describe('subscriptionPauseReasonsReceive', () => {
    test('should return SUBSCRIPTION_PAUSE_REASONS_RECEIVE action type', () => {
    ...
    test('should return received data', () => {
      const result = subPauseActions.subscriptionPauseReasonsReceive([{ id: 'r1' }, { id: 'r2' }])

      expect(result.reasons).toEqual([{ id: 'r1' }, { id: 'r2' }])
    })
  })
  ...
  describe('subscriptionPauseTrack', () => {
    ...
    test('should return trackingData with correctly constructed string for actionType by default', () => {
    ...
    test('should return trackingData with additional data merged in if provided', () => {
      const result = subPauseActions.subscriptionPauseTrack('test_key', {
        extraDataOne: 1,
        extraDataTwo: 2,
      })
  ...
  describe('subscriptionPauseFetchReasons', () => {
    let getState
    let dispatch
    const subscriptionPauseReasonsReceiveSpy = jest.spyOn(
      subPauseActions,
    ...
    beforeEach(() => {
      ...
      dispatch = jest.fn()
      customersApi.fetchPauseReasons.mockReturnValue(
        new Promise((resolve) => {
          resolve({
            data: ['1', '2'],
            meta: {
    ...
    test('should call subscriptionPauseReasonsReceive with received data', async () => {
      await subPauseActions.subscriptionPauseFetchReasons()(dispatch, getState)
    ...
    describe('when no reasons are retrieved', () => {
      ...
      test('should call subscriptionPauseLoadError with no-pause-reasons GoustoException as first arg', () => {
        const error = subscriptionPauseLoadErrorSpy.mock.calls[0][0]
      ...
      test('should call subscriptionPauseLoadError with "SUBSCRIPTION_PAUSE_FETCH" as second arg', async () => {
        expect(subscriptionPauseLoadErrorSpy.mock.calls[0][1]).toEqual(
          actionTypes.SUBSCRIPTION_PAUSE_FETCH,
        )
      })
    })
    ...
    describe('when fetch fails', () => {
      beforeEach(async () => {
        // eslint-disable-next-line prefer-promise-reject-errors
        customersApi.fetchPauseReasons.mockRejectedValueOnce(
          new Error('response from deactivateSubscription'),
        )
        await subPauseActions.subscriptionPauseFetchReasons()(dispatch, getState)
      })

      test('should call subscriptionPauseFetchReasons with fetch-failed GoustoException as first arg', () => {
        const error = subscriptionPauseLoadErrorSpy.mock.calls[0][0]
        expect(error.message).toEqual(
          'Subscripton pause fetch error: fetch failed, Error: response from deactivateSubscription',
        )
        expect(error.error).toEqual('fetch-failed')
        expect(error.level).toEqual('error')
      })

      test('should call subscriptionPauseFetchReasons with "SUBSCRIPTION_PAUSE_FETCH" as second arg', async () => {
        expect(subscriptionPauseLoadErrorSpy.mock.calls[0][1]).toEqual(
          actionTypes.SUBSCRIPTION_PAUSE_FETCH,
        )
      })
  ...
  describe('subscriptionPauseLoadError', () => {
    let dispatch
    const subscriptionPauseLoadStaticScreenSpy = jest.spyOn(
      subPauseActions,
    ...
    test('should call logger "error" by default with error.message if error message is available', () => {
    ...
    test('should call logger "error" by default with error value if error message is not available', () => {
    ...
    test('should call correct logger method matching error.level if provided, along with error message', () => {
    ...
    test('should call statusActions error once with SUBSCRIPTION_PAUSE_ERROR actionType by default', () => {
      subPauseActions.subscriptionPauseLoadError({ error: 'error-key' })(dispatch)

      expect(statusActions.error).toHaveBeenCalledTimes(1)
      expect(statusActions.error).toHaveBeenCalledWith(
        actionTypes.SUBSCRIPTION_PAUSE_ERROR,
        'error-key',
      )
    })

    test('should call statusActions error once with given actionType & error.error if both are provided', () => {
    ...
    test('should NOT call statusActions error if false is provided as actionType', () => {
    ...
    test('should call subscriptionPauseTrack once with error.message if error message is available', () => {
      subPauseActions.subscriptionPauseLoadError({ message: 'message from object' })(dispatch)

      expect(subscriptionPauseTrackSpy).toHaveBeenCalledTimes(1)
      expect(subscriptionPauseTrackSpy).toHaveBeenCalledWith('ERROR', {
        error: 'message from object',
      })
    })

    test('should call subscriptionPauseTrack once with with error value if error message is not available', () => {
      subPauseActions.subscriptionPauseLoadError('Error string')(dispatch)
  ...
  describe('subscriptionPauseGoBack', () => {
    ...
    describe('when staticScreenId is set in state', () => {
      ...
      test('should call subscriptionPauseLoadStaticScreen once with undefined', () => {
        subPauseActions.subscriptionPauseGoBack()(dispatch, getState)
    ...
    describe('when staticScreenId is NOT set & activeStepId NOT on initial step in state', () => {
      ...
      describe('when previousStepId is not available', () => {
        ...
        test('should call subscriptionPauseLoadError with no-prev-step GoustoException as first arg', () => {
          const error = subscriptionPauseLoadErrorSpy.mock.calls[0][0]
          expect(error.message).toEqual(
            "Subscription pause go back error: can't find previous step to go back to",
          )
          expect(error.error).toEqual('no-prev-step')
          expect(error.level).toEqual('error')
        })

        test('should call subscriptionPauseLoadError with "SUBSCRIPTION_PAUSE_REASON_GO_BACK" as second arg', async () => {
          expect(subscriptionPauseLoadErrorSpy.mock.calls[0][1]).toEqual(
    ...
    describe('when staticScreenId is NOT set & activeStepId is on initial step or activeStepId is not set in state', () => {
      ...
      beforeEach(() => {
        ...
        getReasonsFromStoreSpy.mockReturnValue(Immutable.fromJS([{ id: 'r3' }, { id: 'r4' }]))
      })

      test('should call subscriptionPauseLoadReasons once with previous reasons', () => {
        subPauseActions.subscriptionPauseGoBack()(dispatch, getState)
      ...
      test('should call subscriptionPauseLoadReasonChoice once with prevChosenReasonIds from state with last item removed', () => {
        subPauseActions.subscriptionPauseGoBack()(dispatch, getState)
      ...
      describe('when no previous reasons found', () => {
        ...
        test('should call subscriptionPauseLoadError with no-prev-step GoustoException as first arg', () => {
          const error = subscriptionPauseLoadErrorSpy.mock.calls[0][0]
          expect(error.message).toEqual(
            "Subscription pause go back error: can't find reasons to go back to",
          )
  ...
  describe('subscriptionPauseRedirect', () => {
    ...
    test('should dispatch subscriptionPauseVisibilityChange with false', async () => {
  ...
  describe('subscriptionPauseReasonSubmit', () => {
    ...
    test('should call statusActions pending with true for "SUBSCRIPTION_PAUSE_REASON_SUBMIT" as first call', async () => {
    ...
    test('should call statusActions error with false for "SUBSCRIPTION_PAUSE_REASON_SUBMIT"', async () => {
      await subPauseActions.subscriptionPauseReasonSubmit()(dispatch, getState)
    ...
    describe('when chosenReasonId not found in state', () => {
      ...
      test('should call subscriptionPauseReasonSubmit with data-unavailable GoustoException as first arg', () => {
        const error = subscriptionPauseLoadErrorSpy.mock.calls[0][0]
      ...
      test('should call subscriptionPauseFetchReasons with "SUBSCRIPTION_PAUSE_REASON_SUBMIT" as second arg', async () => {
        expect(subscriptionPauseLoadErrorSpy.mock.calls[0][1]).toEqual(
          actionTypes.SUBSCRIPTION_PAUSE_REASON_SUBMIT,
        )
      })
    ...
    describe('when data is available', () => {
      ...
      test('should call deactivateSubscription', async () => {
        await subPauseActions.subscriptionPauseReasonSubmit()(dispatch, getState)
      ...
      describe('when open user orders found in state', () => {
        ...
        test('should call subscriptionPauseLoadStaticScreen with "pausedPendingBoxes"', async () => {
      ...
      describe('when NO open user orders found in state', () => {
        ...
        test('should call subscriptionPauseProceed once with "pause" and "paused"', async () => {
          expect(subscriptionPauseProceedSpy).toHaveBeenCalledTimes(1)
      ...
      describe('on deactivate failure', () => {
        ...
        test('should call subscriptionPauseReasonSubmit with data-unavailable GoustoException as first arg', () => {
          const error = subscriptionPauseLoadErrorSpy.mock.calls[0][0]
          expect(error.message).toEqual(
            'Unable to submit reason: error message from subscriptionDeactivate',
          )
  ...
  describe('subscriptionPauseCancelPendingOrders', () => {
    ...
    beforeEach(() => {
      ...
      dispatch = jest.fn()
      cancelPendingOrders.mockResolvedValue()
    })
    ...
    test('should call cancelPendingOrders', async () => {
      await subPauseActions.subscriptionPauseCancelPendingOrders()(dispatch, getState)

      expect(cancelPendingOrders).toHaveBeenCalledTimes(1)
      expect(cancelPendingOrders).toHaveBeenCalledWith(
        dispatch,
        getState,
        state.auth.get('accessToken'),
        state.user.get('id'),
      )
    })
    ...
    test('should call subscriptionPauseTrack once with corrrect data', async () => {
      await subPauseActions.subscriptionPauseCancelPendingOrders()(dispatch, getState)
    ...
    test('should call subscriptionPauseProceed with "pause" and "paused"', async () => {
      await subPauseActions.subscriptionPauseCancelPendingOrders()(dispatch, getState)
    ...
    describe('when an error occurs in cancelling pending orders', () => {
      beforeEach(async () => {
        cancelPendingOrders.mockRejectedValueOnce(new Error('Borked!'))

        await subPauseActions.subscriptionPauseCancelPendingOrders()(dispatch, getState)
      })

      test('should call subscriptionPauseLoadError with cancel-pending-fail GoustoException as first arg', () => {
        const error = subscriptionPauseLoadErrorSpy.mock.calls[0][0]
        expect(error.message).toEqual(
          'Subscription pause cancel pending order error: cancel pending orders failed, Error: Borked!',
        )
    ...
    describe('when an error occurs after cancelling pending orders', () => {
      beforeEach(async () => {
        subscriptionPauseTrackSpy.mockImplementationOnce(() => {
      ...
      test('should call subscriptionPauseLoadError with error as first arg', () => {
        const error = subscriptionPauseLoadErrorSpy.mock.calls[0][0]
  ...
  describe('subscriptionPauseProceed', () => {
    ...
    test('should call subscriptionPauseLoadStep with nextStepId if available, along with related screen data for tracking, by default', async () => {
    ...
    test('should call subscriptionPauseLoadStep with pauseStepId if called with "pause"', async () => {
    ...
    test('should call subscriptionPauseLoadStep with cancelStepId if called with "cancel"', async () => {
    ...
    test('should call subscriptionPauseLoadStep with step flagged as initial in activeSteps if called with "initial"', async () => {
      getState = jest.fn().mockReturnValue({
        features: Immutable.fromJS({}),
        auth: Immutable.fromJS({ accessToken: 'token' }),
        subscriptionPause: Immutable.fromJS({
    ...
    test('should call subscriptionPauseLoadStep with step flagged as initial in activeSteps if there is no activeStep set in state', async () => {
      getState = jest.fn().mockReturnValue({
        features: Immutable.fromJS({}),
        auth: Immutable.fromJS({ accessToken: 'token' }),
        subscriptionPause: Immutable.fromJS({
    ...
    test('should call subscriptionPauseLoadStep step with first step in activeSteps if there is no activeStep set in state & no step flaged as initial regardless of stepType', async () => {
      getState = jest.fn().mockReturnValue({
        features: Immutable.fromJS({}),
        auth: Immutable.fromJS({ accessToken: 'token' }),
        subscriptionPause: Immutable.fromJS({
    ...
    test('should call subscriptionPauseLoadStaticScreen with "error" by default if there are no activeSteps', async () => {
      getState = jest.fn().mockReturnValue({
        features: Immutable.fromJS({}),
        auth: Immutable.fromJS({ accessToken: 'token' }),
        subscriptionPause: Immutable.fromJS({
    ...
    test('should call subscriptionPauseLoadStaticScreen with provided staticScreenFallback if provided and there are no activeSteps', async () => {
      getState = jest.fn().mockReturnValue({
        features: Immutable.fromJS({}),
        auth: Immutable.fromJS({ accessToken: 'token' }),
        subscriptionPause: Immutable.fromJS({
      ...
      await subPauseActions.subscriptionPauseProceed('cancel', 'some-fallback-screen')(
        dispatch,
        getState,
      )
  ...
  describe('subscriptionPauseLoadInitReasons', () => {
    ...
    test('should call subscriptionPauseLoadInitReasons with initial reasons', () => {
      ...
      expect(
        Immutable.is(
          subscriptionPauseLoadReasonsSpy.mock.calls[0][0],
          Immutable.fromJS([
            {
              id: '7',
              slug: 'narrower_time_slots',
  ...
  describe('OSR tracking', () => {
    ...
    test('should dispatch PS_SUBSCRIPTION_KEPT_ACTIVE and the correct data when calling subscriptionPauseProceed with "cancel"', () => {
      subPauseActions.subscriptionPauseProceed(
        'cancel',
        'some-fallback-screen',
        'recovery-type',
        'promo-code',
      )(dispatch, getState)
    ...
    test('should dispatch PS_SUBSCRIPTION_KEPT_ACTIVE and the correct data when calling subscriptionPauseProceed with "next"', () => {
      subPauseActions.subscriptionPauseProceed(
        'next',
        'some-fallback-screen',
        'recovery-type',
    ...
    test('should dispatch PS_RECOVERY_ATTEMPT_MODAL_VIEWED and the correct data when calling subscriptionPauseProceed with "initial" and the next modal type is not "other"', () => {
      subPauseActions.subscriptionPauseProceed(
        'initial',
        'some-fallback-screen',
        'recovery-type',
    ...
    test('should not dispatch PS_RECOVERY_ATTEMPT_MODAL_VIEWED when calling subscriptionPauseProceed with "initial" and the modal type is "other"', () => {
      getState = jest.fn().mockReturnValue({
        features: Immutable.fromJS({}),
        subscriptionPause: Immutable.fromJS({
          activeStepId: 's1',
    ...
    test('should dispatch PS_END_MODAL_VIEWED when calling subscriptionPauseProceed with a stepType that leads to a step of type "recovered"', () => {
      getState = jest.fn().mockReturnValue({
        features: Immutable.fromJS({}),
        subscriptionPause: Immutable.fromJS({
          activeStepId: 's1',
    ...
    test('should dispatch PS_END_MODAL_VIEWED when calling subscriptionPauseProceed with a stepType that leads to a step of type "recoveredPromo"', () => {
      getState = jest.fn().mockReturnValue({
        features: Immutable.fromJS({}),
        subscriptionPause: Immutable.fromJS({
          activeStepId: 's1',
    ...
    test('should dispatch PS_END_MODAL_VIEWED when calling subscriptionPauseProceed with a stepType that leads to a step of type "recoveredSkipped"', () => {
      getState = jest.fn().mockReturnValue({
        features: Immutable.fromJS({}),
        subscriptionPause: Immutable.fromJS({
          activeStepId: 's1',
    ...
    test('should dispatch PS_END_MODAL_VIEWED when calling subscriptionPauseProceed with a stepType that leads to a step of type "paused"', () => {
      getState = jest.fn().mockReturnValue({
        features: Immutable.fromJS({}),
        subscriptionPause: Immutable.fromJS({
          activeStepId: 's1',
    ...
    test('should dispatch PS_REASON_CATEGORY_MODAL_VIEW when subscriptionPauseGoBack is called from an initial step', async () => {
    ...
    test('should dispatch PS_SUBSCRIPTION_KEPT_ACTIVE with corresponding data when subscriptionPauseRedirect is called to redirect to my deliveries', async () => {
      await subPauseActions.subscriptionPauseRedirect(routesConfig.client.myDeliveries)(
        dispatch,
        getState,
      )
      ...
      expect(dispatch).toHaveBeenCalledWith({
        ...
        ...keptActiveActionSample2,
      })
    })

    test('should dispatch PS_SUBSCRIPTION_KEPT_ACTIVE with corresponding data when subscriptionPauseRedirect is called to redirect to contact', async () => {
    ...
    test('should not dispatch PS_SUBSCRIPTION_KEPT_ACTIVE when subscriptionPauseRedirect is called to redirect to other places', async () => {
    ...
    test('should dispatch PS_SUBSCRIPTION_PAUSED and correct data when subscriptionPauseReasonSubmit is called', async () => {
      await subPauseActions.subscriptionPauseReasonSubmit()(dispatch, getState)
    ...
    test('should dispatch PS_REASON_CATEGORY_SELECTED, PS_REASON_LIST_MODAL_VIEWED, and the selected category when subscriptionPauseReasonChoice is called selecting a category', async () => {
      getState = jest.fn().mockReturnValue({
        features: Immutable.fromJS({}),
        subscriptionPause: Immutable.fromJS({
          chosenReasonIds: [],
    ...
    test('should dispatch PS_SUBSCRIPTION_KEPT_ACTIVE and correct data when calling subscriptionPauseEnd if the subscription status is active', () => {
      getState = jest.fn().mockReturnValue({
        user: Immutable.fromJS({
      ...
      expect(dispatch).toHaveBeenCalledWith({
        ...
        trackingData: { actionType: 'recover_subscription' },
      })
    })

    test('should not dispatch PS_SUBSCRIPTION_KEPT_ACTIVE when calling subscriptionPauseEnd if the subscription status is not active', () => {
      getState = jest.fn().mockReturnValue({
        features: Immutable.fromJS({}),
        user: Immutable.fromJS({
    ...
    test('should dispatch PS_START_MODAL_VIEWED when calling subscriptionPauseLoadStartScreen', () => {
      getState = jest.fn().mockReturnValue({
        features: Immutable.fromJS({}),
        subscriptionPause: Immutable.fromJS({
    ...
    test('should dispatch PS_REASON_LIST_MODAL_VIEWED when calling subscriptionPauseLoadInitReasons', () => {
      subPauseActions.subscriptionPauseLoadInitReasons()(dispatch, getState)

      expect(dispatch).toHaveBeenCalledWith({ type: actionTypes.PS_REASON_LIST_MODAL_VIEWED })
    })

    test('should fetch user data and dispatch PS_SUBSCRIPTION_PAUSE_ATTEMPT with the metaData obtained from customer service when calling subscriptionPauseStart and there is startScreen', async () => {
      getState = jest.fn().mockReturnValue({
        features: Immutable.fromJS({}),
        subscriptionPause: Immutable.fromJS({
          metaData: { meta: 'data' },
    ...
    test('should fetch user data and dispatch PS_SUBSCRIPTION_PAUSE_ATTEMPT with the metaData obtained from customer service and PS_REASON_CATEGORY_MODAL_VIEWED when calling subscriptionPauseStart and there is not startScreen but there are initialReasons', async () => {
      getState = jest.fn().mockReturnValue({
        features: Immutable.fromJS({}),
        subscriptionPause: Immutable.fromJS({
          metaData: { meta: 'data' },
  ...
  describe('fetchData', () => {
    ...
    const mockState = {
      ...
      subscriptionPause: Immutable.fromJS({
        startScreen: [{ id: 123, steps: [{ id: 456 }] }],
        metaData: {
          some: 'metadata',
        },
      }),
    ...
    beforeEach(() => {
      getState = () => mockState
      dispatch = (action) =>
        (typeof action === 'function' ? action(mockDispatch, getState) : mockDispatch(action))
    })

    test('should dispatch pause attempt action', async () => {
      await fetchData()(dispatch, getState)

      expect(mockDispatch).toHaveBeenCalledWith({
        type: 'PS_SUBSCRIPTION_PAUSE_ATTEMPT',
        metaData: Immutable.fromJS({ some: 'metadata' }),
      })
    })
