...
describe('basketProductLimits utils', () => {
  describe('productsOverallLimitReached', () => {
    it('should return true if overall box limit has been reached', () => {
    ...
    it('should account for gift products by default', () => {
    ...
    it('should return false if overall box limit has NOT been reached', () => {
      const basket = Immutable.fromJS({
        products: { 'product-1': 5, 'product-2': 3 },
        gifts: { 'product-1': 1 },
      })
    ...
    it('should NOT account for gift products if includeGiftProducts is false', () => {
      const basket = Immutable.fromJS({
        products: { 'product-1': 5, 'product-2': 3 },
        gifts: { 'product-1': 2 },
      })
  ...
  describe('getFirstProductCategoryAtLimit', () => {
    let basket
    beforeEach(() => {
      basket = Immutable.fromJS({
        products: { 'product-1': 5, 'product-2': 6 },
    ...
    it('should return name of first category found to have reached its category limit for any given product', () => {
    ...
    it('should return false if none of the product\'s categories are at their limit', () => {
      const products = Immutable.fromJS({
        'product-1': {
          id: 'product-1',
          categories: [
  ...
  describe('getProductItemLimitReached', () => {
    it('should return item limit of given product if item limit has been reached', () => {
      const basket = Immutable.fromJS({
        products: { 'product-1': 5, 'product-2': 3 },
        gifts: {},
      })
    ...
    it('should return false if product is not at item limit', () => {
      const basket = Immutable.fromJS({
  ...
  describe('productCanBeAdded', () => {
    it('should return true if product is in stock & has not hit any limits', () => {
    ...
    it('should return false if product has hit any of its limits', () => {
