...
describe('RecipeList selectors', () => {
  ...
  beforeEach(() => {
    ...
    getMenuCollections = Immutable.fromJS({
      [VALID_COLLECTION_ID]: {
        recipesInCollection: [firstRecipe.get('id'), secondRecipe.get('id')],
      },
    })
  ...
  describe('getRecipeComparatorFactory', () => {
    ...
    beforeEach(() => {
      comparator =
        recipeListSelectors.getRecipeComparatorFactory.resultFunc(inStockRecipes)(allRecipes)
    })
    ...
    describe('when comparator given two in stock recipes', () => {
      ...
      describe('when A is missing from original order', () => {
        ...
        beforeEach(() => {
          ...
          comparator =
            recipeListSelectors.getRecipeComparatorFactory.resultFunc(inStockRecipes)(
              filteredRecipes
            )
        })
  ...
  describe('getFilterFn', () => {
    describe('when no recommendations collection', () => {
      ...
      test('should return null', () => {
        const result = recipeListSelectors.getFilterFn.resultFunc(
          collectionId,
    ...
    describe('when on recommendations collection', () => {
      ...
      test('should return true for in-stock recipe', () => {
        const filterFn = recipeListSelectors.getFilterFn.resultFunc(
          currentCollectionId,
          recommendationCollection,
          inStockRecipes
        )
  ...
  describe('getRecipeListRecipes', () => {
    ...
    describe('no collection id provided', () => {
      ...
      test('should return all recipes, applying comparator', () => {
        const { recipes } = recipeListSelectors.getRecipeListRecipes.resultFunc(
          allRecipes,
          getMenuCollections,
          inStockRecipes,
          currentMenuVariants,
        ...
        expect(recipes).toEqual(
          Immutable.List([
            ...
            createStandardRecipeView(thirdRecipe),
            createStandardRecipeView(variantRecipe),
          ])
        )
      })
    ...
    describe('collection id provided', () => {
      ...
      describe('when filterFn provided', () => {
        ...
        test('should return all recipes in collection with filterFn applied', () => {
          ...
          expect(recipes).toEqual(Immutable.List([createStandardRecipeView(firstRecipe)]))
        })
      })
    ...
    describe('full state test', () => {
      ...
      describe('when props contains collection id', () => {
        ...
        test('should return correct list', () => {
          const { recipes } = recipeListSelectors.getRecipeListRecipes(state, props)
