...
describe('utils/validation', () => {
  ...
  describe('validateDigits', () => {
    test('should return false', () => {
      ...
      expect(validateDigits('35465768798766546356547 6879675645577 887877887787877887')).toBe(false)
      expect(validateDigits('3546576879876Q£&Y&Q$&Q@^@£*&*(*(87787877887')).toBe(false)
