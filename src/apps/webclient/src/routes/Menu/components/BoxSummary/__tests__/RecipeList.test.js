...
describe('RecipeList', () => {
  ...
  test('should call boxDetailsVisibilityChange once browser mobile', () => {
    const boxDetailsVisibilityChange = jest.fn()
    const wrapper = shallow(
      <RecipeList
        recipes={Immutable.Map({ 101: {} })}
  ...
  test('should not call boxDetailsVisibilityChange once browser mobile and box summary is visible', () => {
    const boxDetailsVisibilityChange = jest.fn()
    const wrapper = shallow(
      <RecipeList
        recipes={Immutable.Map({ 101: {} })}
