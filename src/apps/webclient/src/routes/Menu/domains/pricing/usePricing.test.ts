...
let useDispatchMock = useDispatch as jest.MockedFunction<typeof useDispatch>
let getBasketSlotId = basketSelectors.getBasketSlotId as jest.MockedFunction<
  typeof basketSelectors.getBasketSlotId
>
let getBasketRecipesCount = basketSelectors.getBasketRecipesCount as jest.MockedFunction<
  typeof basketSelectors.getBasketRecipesCount
>
let getOrderV2 = orderSelectors.getOrderV2 as jest.MockedFunction<any>
let useSWRMock = useSWR as jest.MockedFunction<any>
