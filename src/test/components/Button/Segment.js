...
describe('Segment', function() {
	...
	it('should not call onClick when Segment is disabled', function() {
		...
		const wrapper = shallow(<Segment onClick={segmentOnClickSpy} color={color} disabled={true} btnDisabled={false}>{children}</Segment>)
	...
	it('should call disabledClick when Segment is disabled', function() {
		...
		const wrapper = shallow(<Segment onClick={segmentOnClickSpy} disabledClick={disabledClickSpy} color={color} disabled={true} btnDisabled={false}>{children}</Segment>)
		wrapper.find('div').simulate('click')
	...
	it('should have tabIndex and role props when not a spinner', function() {
		...
		const wrapper = shallow(<Segment onClick={segmentSpy} color={color} disabled={true} btnDisabled={false}>{children}</Segment>)
	...
	it('should not be able to click when Button is disabled', function() {
		let segmentSpy = sinon.spy()
		const wrapper = shallow(<Segment onClick={segmentSpy} color={color} disabled={false} btnDisabled={true}>{children}</Segment>)
		wrapper.find('div').simulate('click')
	...
	it('should not be able to click when both Segment and Button is disabled', function() {
		let segmentSpy = sinon.spy()
		const wrapper = shallow(<Segment onClick={segmentSpy} color={color} disabled={true} btnDisabled={true}>{children}</Segment>)
		wrapper.find('div').simulate('click')
