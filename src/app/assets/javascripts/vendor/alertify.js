	...
	c = function() {
		...
		return r = {
			buttons: {
				...
				submit: '<button type="submit" class="gbtn-primary alertify-button alertify-button-ok" id="alertify-ok">{{ok}}</button>',
				ok: '<button data-selid="alert-ok" class="gbtn-primary alertify-button alertify-button-ok" id="alertify-ok">{{ok}}</button>',
				cancel: '<button data-selid="alert-cancel" class="gbtn-secondary alertify-button alertify-button-cancel" id="alertify-cancel">{{cancel}}</button>'
			},
			input: '<div class="alertify-text-wrapper"><input type="text" class="alertify-text" id="alertify-text"></div>',
			message: '<p data-selid="alert-popup" class="alertify-message">{{message}}</p>',
